...
def send_notification(event_name, context=None, site=None, request=None,
                      **kwargs):
    ...
    for backend in backends.values():
        backend.send_notification(event_name,
            context=context, site=site, request=request, **kwargs)
