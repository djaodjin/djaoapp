...
(function ($){
    ...
    EditPlan.prototype = {
        init: function(){
            var self = this;
            var editionTool = "<button class=\"edit-plan close\" style=\"position:absolute;top:30px; left:20px;\"><i class=\"fa-solid fa-pencil icon_edition\"></i></button><button class=\"text-danger trash-plan close\" style=\"position:absolute;top:30px; right:20px;\"><i class=\"fa-solid fa-trash icon_edition\"></i></button>";
