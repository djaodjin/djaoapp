        ...
        selection.each(function(data) {
            ...
            linePaths.enter().append('path')
                ...
                .attr('d',
                    ...
                    .x(function(d,i) {
/*DEBUG:
                        console.log('XXX .nv-line, nv.utils.NaNtoZero(x0(getX(',
                            d,',',i,')))=>nv.utils.NaNtoZero(x0(',
                            getX(d,i),')) in [',x0.domain(),']=>nv.utils.NaNtoZero(',
                            x0(getX(d,i)),')=',
                            nv.utils.NaNtoZero(x0(getX(d,i))));
*/
                        return nv.utils.NaNtoZero(x0(getX(d,i)))
                    })
                    .y(function(d,i) {
/*DEBUG:
                        console.log('XXX .nv-line, nv.utils.NaNtoZero(y0(getY(',
                            d,',',i,')))=>nv.utils.NaNtoZero(y0(',
                            getY(d,i),'))=>nv.utils.NaNtoZero(',
                            y0(getY(d,i)),')=',
                            nv.utils.NaNtoZero(y0(getY(d,i))));
*/
...
nv.models.scatter = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            /* XXX disable to be able to show a line through an enum on xAxis.
            if ( isNaN(x.domain()[0])) {
                x.domain([-1,1]);
            }
            */
