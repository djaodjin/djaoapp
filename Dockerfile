...
#2026-05-19: python:3.12-slim-bookworm - Python 3.12.13, Debian 13.4 (Trixie)
...
RUN set -eux; \
      ...
      apt-get -y install --no-install-recommends \
        ...
        pkg-config; \
      \
      /app/bin/pip install billiard==4.0.0 cairocffi==1.3.0 coverage==7.2.7 cryptography==46.0.6 psycopg2-binary==2.9.12 pycairo==1.21.0 python-ldap==3.4.5 setproctitle==1.3.7; \
      /app/bin/pip install xmlsec==1.3.17; \
      ...
      /app/bin/pip install boto3==1.42.89 Django==5.2.14 django-csp==4.0 django-phonenumber-field==7.1.0 django-recaptcha==4.0.0 djangorestframework==3.16.1 djaodjin-deployutils==0.14.5 djaodjin-extended-templates==0.5.3 djaodjin-multitier==0.3.2 djaodjin-rules==0.4.12 djaodjin-saas==1.2.3 djaodjin-signup==0.11.4 docutils==0.21.2 drf-spectacular==0.29.0 googlemaps==4.10.0 gunicorn==23.0.0 jinja2==3.1.6 phonenumbers==8.13.17 pydyf==0.12.1 PyJWT==2.13.0 pyotp==2.8.0 pytz==2026.1.post1 social-auth-app-django==5.4.3 stripe==12.5.1 whitenoise==6.4.0 WeasyPrint==68.1 django-storages==1.14.2; \
      /app/bin/pip install django-debug-toolbar==6.2.0 django-extensions==4.1; \
      \
      apt-mark auto '.*'; \
