...
RUN set -eux; \
      ...
      /app/bin/pip install boto3==1.33.13 Django==4.2.26 django-phonenumber-field==7.1.0 django-recaptcha==4.0.0 djangorestframework==3.15.2 djaodjin-deployutils==0.14.2 djaodjin-extended-templates==0.4.11 djaodjin-multitier==0.3.1 djaodjin-rules==0.4.10 djaodjin-saas==1.1.5 djaodjin-signup==0.10.4 docutils==0.15.2 drf-spectacular==0.27.0 googlemaps==4.10.0 gunicorn==23.0.0 jinja2==3.1.6 phonenumbers==8.13.17 PyJWT==2.10.1 pyotp==2.8.0 pytz==2025.1 social-auth-app-django==5.4.3 stripe==12.5.1 whitenoise==6.4.0 WeasyPrint==53.4 django-storages==1.14.2; \
