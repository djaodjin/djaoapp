...
RUN set -eux; \
      ...
      /app/bin/pip install boto3==1.33.13 Django==4.2.28 django-phonenumber-field==7.1.0 django-recaptcha==4.0.0 djangorestframework==3.15.2 djaodjin-deployutils==0.14.3 djaodjin-extended-templates==0.4.12 djaodjin-multitier==0.3.1 djaodjin-rules==0.4.11 djaodjin-saas==1.2.1 djaodjin-signup==0.11.1 docutils==0.15.2 drf-spectacular==0.27.0 googlemaps==4.10.0 gunicorn==23.0.0 jinja2==3.1.6 phonenumbers==8.13.17 pydyf==0.1.2 PyJWT==2.10.1 pyotp==2.8.0 pytz==2025.2 social-auth-app-django==5.4.3 stripe==12.5.1 whitenoise==6.4.0 WeasyPrint==53.4 django-storages==1.14.2; \
