...
RUN set -eux; \
      ...
      apt-get -y install --no-install-recommends \
        ...
        pkg-config; \
      \
      /app/bin/pip install billiard==4.0.0 cairocffi==1.3.0 coverage==7.2.7 cryptography==46.0.6 psycopg2-binary==2.9.3 pycairo==1.21.0 python-ldap==3.4.5 setproctitle==1.2.3; \
      ...
      /app/bin/pip install boto3==1.33.13 Django==4.2.29 django-phonenumber-field==7.1.0 django-recaptcha==4.0.0 djangorestframework==3.16.1 djaodjin-deployutils==0.14.5 djaodjin-extended-templates==0.4.12 djaodjin-multitier==0.3.1 djaodjin-rules==0.4.11 djaodjin-saas==1.2.2 djaodjin-signup==0.11.4 docutils==0.15.2 drf-spectacular==0.27.0 googlemaps==4.10.0 gunicorn==23.0.0 jinja2==3.1.6 phonenumbers==8.13.17 pydyf==0.1.2 PyJWT==2.12.0 pyotp==2.8.0 pytz==2026.1.post1 social-auth-app-django==5.6.0 stripe==12.5.1 whitenoise==6.4.0 WeasyPrint==53.4 django-storages==1.14.2; \
