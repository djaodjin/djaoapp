...
RUN set -eux; \
      ...
      /app/bin/pip install boto3==1.42.89 Django==5.2.14 django-csp==4.0 django-phonenumber-field==7.1.0 django-recaptcha==4.0.0 djangorestframework==3.16.1 djaodjin-deployutils==0.14.5 djaodjin-extended-templates==0.5.3 djaodjin-multitier==0.3.2 djaodjin-rules==0.4.11 djaodjin-saas==1.2.3 djaodjin-signup==0.11.4 docutils==0.21.2 drf-spectacular==0.29.0 googlemaps==4.10.0 gunicorn==23.0.0 jinja2==3.1.6 phonenumbers==8.13.17 pydyf==0.12.1 PyJWT==2.12.0 pyotp==2.8.0 pytz==2026.1.post1 social-auth-app-django==5.4.3 stripe==12.5.1 whitenoise==6.4.0 WeasyPrint==68.1 django-storages==1.14.2; \
