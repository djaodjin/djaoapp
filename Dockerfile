...
RUN set -eux; \
      ...
      apt-get -y install --no-install-recommends \
        ...
        pkg-config; \
      \
      /app/bin/pip install billiard==4.0.0 cairocffi==1.3.0 coverage==7.2.7 cryptography==46.0.6 psycopg2-binary==2.9.12 pycairo==1.21.0 python-ldap==3.4.5 setproctitle==1.2.3; \
