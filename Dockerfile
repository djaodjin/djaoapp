...
RUN set -eux; \
      ...
      apt-get -y install --no-install-recommends \
        ...
        pkg-config; \
      \
      /app/bin/pip install billiard==4.0.0 cairocffi==1.3.0 coverage==7.2.7 cryptography==41.0.3 psycopg2-binary==2.9.3 pycairo==1.21.0 python-ldap==3.4.0 setproctitle==1.2.3; \
      /app/bin/pip install boto3==1.33.13 Django==3.2.25 django-phonenumber-field==7.1.0 django-recaptcha==3.0.0 djangorestframework==3.14.0 djaodjin-deployutils==0.12.0 djaodjin-extended-templates==0.4.7 djaodjin-multitier==0.2.1 djaodjin-rules==0.4.8 djaodjin-saas==1.0.1 djaodjin-signup==0.9.9 docutils==0.15.2 drf-spectacular==0.27.0 googlemaps==4.10.0 gunicorn==23.0.0 jinja2==3.1.3 MarkupSafe==2.1.1 phonenumbers==8.13.13 PyJWT==2.6.0 pyotp==2.8.0 pytz==2025.1 social-auth-app-django==5.2.0 whitenoise==6.4.0 WeasyPrint==53.4; \
